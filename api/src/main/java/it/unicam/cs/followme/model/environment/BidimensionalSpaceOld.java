...
//    public static List<ProgrammableObject> getNeighbours(TwoDimensionalPoint positionToCheck, String labelToCheck, Double range){
//        List<ProgrammableObject> neighbours = this.programmablesInSpace.parallelStream();
