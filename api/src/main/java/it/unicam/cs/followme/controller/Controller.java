...
public class Controller<S extends Shape, P extends ProgrammableObject> {
    ...
    /**
     * Rimuove il signal dei robot.
     * @param robot il robot di cui rimuovere il signal.
     */
    private void resetLable(Robot robot) {
        RobotLanguageAtomicConstructs.unsignal(robot);
    }
}
